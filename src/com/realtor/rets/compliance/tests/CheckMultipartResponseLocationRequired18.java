 ...
 * @author pobrien
 */
public class CheckMultipartResponseLocationRequired18 extends BaseEvaluator {


  public CheckMultipartResponseLocationRequired18() {
  }
		  ...
		  String notes="Content-type:"+contentTypeString+" boundary "+boundary;
		    ...
		    Iterator iterator = ((RETSGetObjectTransaction) t).allReturnedObjects().iterator();
			    ...
			    try{
        			...
        			String location=part.getHeader("Location",";");
        		 	if (contentId==null||objectId==null||mimeVersion==null||location==null){
						  return reportResult("CheckMultipartResponse",
						                                                "missing required header field(s):"
						                                                + "Content-ID, Object-ID,MIME-Version and Location must all be present"
