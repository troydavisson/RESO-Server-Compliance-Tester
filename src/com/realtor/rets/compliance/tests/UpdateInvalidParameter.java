 ...
 * @author pobrien
 */
public class UpdateInvalidParameter extends NegativeBaseEvaluator {

    private static Log log = LogFactory.getLog(UpdateInvalidParameter.class);

    private final static String msf_EXPECTED_STATUS_RESPONSE_CODE = "20301";

    /**
     *
     */
    public UpdateInvalidParameter() {
        super();
