 ...
 * @author pobrien
 */
public class UpdateNoSaveToDatabase extends NegativeBaseEvaluator {

    private static Log log = LogFactory.getLog(UpdateNoSaveToDatabase.class);

    private final static String msf_EXPECTED_STATUS_RESPONSE_CODE = "20302";

    /**
     *
     */
    public UpdateNoSaveToDatabase() {
        super();
