 ...
 * @author pobrien
 */
public class MetadataClass0 extends BaseEvaluator {

  public MetadataClass0() {
    super();
    specReference = "";
  }
...
private String errorList="";
  ...
  protected TestResult processResults(String transName, RETSTransaction t) {
      ...
      int cnt=CollectionUtils.keyCount(m,"content-type");
        ...
        if (cnt > 1)
        {
            ...
            return reportResult("MetadataClass0", mContent,"Info",note,"n/a");
   ...
   */
  protected TestResult validateClass0(String transactionName,
                                       String responseBody) {
