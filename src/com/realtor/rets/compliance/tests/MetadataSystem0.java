 ...
 * @author pobrien
 */
public class MetadataSystem0 extends BaseEvaluator {

  public MetadataSystem0() {
    super();
    specReference = "";
  }
...
private String errorList="";
  ...
  protected TestResult processResults(String transName, RETSTransaction t) {
      ...
      int cnt=CollectionUtils.keyCount(m,"content-type");
        ...
        if (cnt > 1)
        {
            ...
            return reportResult("MetadataSystem0", mContent,"Info",note,"n/a");
   ...
   */
  protected TestResult validateSystem0(String transactionName,
                                       String responseBody) {
    ...
    String jException="";
      ...
      if ((responseBody != null) && (responseBody.length() > 0)) {
		...
		if(found){
		return reportResult("MetadataSystem0:  "+transactionName,
		                        "Checks to see if the the transaction has valid breadth and depth",
		                        status, "Child metadata found beneath METADATA-SYSTEM: "+notes,jException,"n/a");
  		}else{
		 return reportResult("MetadataSystem0:  "+transactionName,
                        "Checks to see if the the transaction has valid breadth and depth",
