 ...
 * @author pobrien
 */
public class CheckMultipartResponseObjectData18 extends BaseEvaluator {


  public CheckMultipartResponseObjectData18() {
  }
...
protected TestResult processResults(String transName,RETSTransaction t) {
      if (t == null) {
		  ...
		  String notes="Content-type:"+contentTypeString+" boundary "+boundary;
		    ...
		    Iterator iterator = ((RETSGetObjectTransaction) t).allReturnedObjects().iterator();
			    ...
			    try{
        			...
        			String objectdata=part.getHeader("ObjectData",";");
        			objectDataList=objectDataList+" "+objectdata;
        		 	if (objectdata==null){
						  return reportResult("CheckMultipartResponse",
						                                                "missing objectdata header field",
						                                                "Info",
			                                              "Missing ObjectData Multipart Header Fields");
        		 	}
        ...
        return reportResult("CheckMultipartResponse",
		                                    "Transaction \"" + transName
		                                      + "\" Multipart contains ObjectData: "+objectDataList,"Success", notes);
