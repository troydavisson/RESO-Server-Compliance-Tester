 ...
 * @author pobrien
 */
public class CheckOptionalResponseHeaders18 extends BaseEvaluator {

  /** Optional response header fields */
  String[] optionalFields = { "content-length", "transfer-encoding", "server", "content-encoding", "rets-request-id","rets-server","set-cookie" };

  /**
   * Creates a new instance of CheckResponseHeaders
   */
  public CheckOptionalResponseHeaders18() {
  }
