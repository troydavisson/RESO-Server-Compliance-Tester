 ...
 * @author pobrien
 */
public class DMQLStandardCompactNumericResultsMax extends DMQLResultsSystem {
	
    private static Log log = LogFactory.getLog(DMQLStandardCompactNumericResultsMax.class);
    ...
    protected void compareDMQLResults(String transName, String responseBody, 
        ...
        if (log.isDebugEnabled()){
            log.debug("* In DMQLStandardCompactNumericResultsMax evaluator class");
        ...
        if (dataList.isEmpty()) {
            ...
            log.error("DMQLStandardCompactNumericResultsMax Failed - "
                            + testResultNotes);
        }
