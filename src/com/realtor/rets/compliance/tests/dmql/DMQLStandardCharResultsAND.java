 ...
 * AND a numeric field's values msf_LESS_THAN_VALUE
 *
 * @author pobrien
 */
public class DMQLStandardCharResultsAND extends DMQLResultsStandard {

    private static Log log = LogFactory.getLog(DMQLStandardCharResultsAND.class);
    ...
    protected TestResult compareDMQLResults(String transName, String responseBody,
        ...
        testResultDesc =
                ...
                " to the field Value " + startCharacters + "* AND make sure the numeric field "
        ...
        if (resultsIt == null) {
            ...
            while (resultsIt.hasNext()) {
                ...
                testFailValue = determineTestResult(secondFieldStrdName, queryResult);
            }
