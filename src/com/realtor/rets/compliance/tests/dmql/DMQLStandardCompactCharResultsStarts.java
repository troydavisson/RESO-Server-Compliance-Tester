 ...
 * @author pobrien
 */
public class DMQLStandardCompactCharResultsStarts extends DMQLResultsSystem {
	
    private static Log log = LogFactory.getLog(DMQLStandardCompactCharResultsStarts.class);
    ...
    protected void compareDMQLResults(String transName, String responseBody, 
        ...
        if (dataList.isEmpty()) {
            ...
            log.error("DMQLStandardCompactCharResultsStarts Failed - " + testResultNotes);
        }
        else {
