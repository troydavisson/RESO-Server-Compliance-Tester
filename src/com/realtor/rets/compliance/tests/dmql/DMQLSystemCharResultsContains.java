 ...
 */
public class DMQLSystemCharResultsContains extends DMQLResultsSystem {

    private static Log log = LogFactory.getLog(DMQLSystemCharResultsContains.class);
    ...
    protected void compareDMQLResults(String transName, String responseBody,
        ...
        String fieldName = getDMQLProperty(DMQL_CHARACTER_CONTAINS_FIELD);
        String containsCharacters = getDMQLProperty(DMQL_CHARACTER_CONTAINS_VALUE);
        ...
        if (dataList.isEmpty()) {
            ...
            log.error("DMQLSystemCharResultsContains Failed - " + testResultNotes);
        }
        else {
