 ...
 */
public class DMQLStandardCompactNumericResultsRange extends DMQLResultsSystem {

    private static Log log = LogFactory.getLog(DMQLStandardCompactNumericResultsRange.class);
    ...
    protected void compareDMQLResults(String transName, String responseBody,
        ...
        if (dataList.isEmpty()) {
            ...
            log.error("DMQLStandardCompactNumericResultsRange Failed - " + testResultNotes);
        }
