 ...
 */
public class DMQLStandardCompactDateResultsMin extends DMQLResultsSystem {

    private static Log log = LogFactory.getLog(DMQLStandardCompactDateResultsMin.class);
	...
	protected void compareDMQLResults(String transName, String responseBody,
        ...
        if (decimalMinimumDataList.isEmpty()) {
            ...
            log.error("DMQLStandardCompactDateResultsGT Failed - " + testResultNotes);
        } else {
