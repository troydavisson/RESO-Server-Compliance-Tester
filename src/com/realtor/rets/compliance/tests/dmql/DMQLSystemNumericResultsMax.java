 ...
 * @author pobrien
 */
public class DMQLSystemNumericResultsMax extends DMQLResultsSystem {
	
    private static Log log = LogFactory.getLog(DMQLSystemNumericResultsMax.class);   
    ...
    protected void compareDMQLResults(String transName, String responseBody, 
        ...
        String fieldName        = getDMQLProperty(DMQL_DECIMAL_MAXIMUM_FIELD);
        String fieldValue       = getDMQLProperty(DMQL_DECIMAL_MAXIMUM_VALUE);
        ...
        if (dataList.isEmpty()) {
            ...
            log.error("DMQLSystemNumericResultsMax Failed - "
                            + testResultNotes);
        }
