 ...
 * field's value, ensuring it is <= 200,000
 * <p/>
 *
 * @author pobrien
 */
public class DMQLStandardNumericResultsMax extends DMQLResultsStandard {

    private static Log log = LogFactory.getLog(DMQLStandardNumericResultsMax.class);
    ...
    protected TestResult compareDMQLResults(String transName, String responseBody,
        ...
        String fieldStrdName = getDMQLProperty(DMQL_DECIMAL_MAXIMUM_FIELD);
        ...
        if (numericResultsIt == null) {
            ...
            log.error("DMQLNumericResultsLT Failed - " + testResultNotes);
        } else {
