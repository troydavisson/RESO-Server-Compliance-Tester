 ...
 * @author pobrien
 */
public class CheckGetObjectOptionalResponseHeaders18 extends BaseEvaluator {

  /** Optional response header fields */

    	String[] optionalFields = {
        "location","description","preferred","uid","objectdata","content-sub-description"
  };

  /**
   * Creates a new instance of CheckResponseHeaders
   */
  public CheckGetObjectOptionalResponseHeaders18() {
  }
