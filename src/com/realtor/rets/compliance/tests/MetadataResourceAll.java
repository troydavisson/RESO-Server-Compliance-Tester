 ...
 * @author pobrien
 */
public class MetadataResourceAll extends BaseEvaluator {

  public MetadataResourceAll() {
    super();
    specReference = "";
  }
...
private String errorList="";
  ...
  protected TestResult processResults(String transName, RETSTransaction t) {
     ...
     int cnt=CollectionUtils.keyCount(m,"content-type");
        ...
        if (cnt > 1)
        {
            ...
            return reportResult("MetadataResource*", mContent,"Info",note,"n/a");
      ...
      if (isXml) {
        ...
        return validateResourceAll(transName,body);
      } else {
        String notes = "Transaction " + cName
                       + " does not include a Content-Type of 'text/xml'";
        return reportResult("MetadataResource*",
   ...
   */
  protected TestResult validateResourceAll(String transactionName,
                                       String responseBody) {
